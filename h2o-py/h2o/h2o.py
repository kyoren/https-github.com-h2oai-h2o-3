...
def remove(id):
  ...
  :param id: The id pointing to the object to be removed.
  :return: Void
  """
  if id is None:
    raise ValueError("remove with no id is not supported, for your protection")

  H2OConnection.delete("DKV/" + id)
